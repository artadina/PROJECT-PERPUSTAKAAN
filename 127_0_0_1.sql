...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 24, 2021 at 04:07 AM
...
(1, 'BUMI', 'TERE LIYE', 'PT GRAMEDIA'),
(2, 'BULAN', 'TERE LIYE', 'PT. GRAMEDIA');
...
(15, 'XI RPL 5', 'Laravel Vue Js'),
(16, 'XI RPL 1', 'Android'),
(17, 'XI RPL 2', 'Node React');
...
(1, 31, '2021-09-21', '2021-09-26'),
(2, 31, '2021-09-21', '2021-09-26'),
(3, 31, '2021-09-21', '2021-09-26'),
(4, 31, '2021-09-21', '2021-09-26'),
(5, 31, '2021-09-21', '2021-09-26'),
(6, 31, '2021-09-22', '2021-09-27'),
(7, 31, '2021-09-24', '2021-09-29');
...
(31, 'Artadina Septiani', '2006-09-11', 'Malang', 'P', 'dinaa', 'dina', 15);
...
--
ALTER TABLE `kelas`
  MODIFY `id_kelas` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `pengembalian_buku`
  MODIFY `id_pengembalian_buku` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `siswa`
--
ALTER TABLE `siswa`
  MODIFY `id_siswa` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
(1, 'root', 'server', 'belajar_laravel', '{\"quick_or_custom\":\"quick\",\"what\":\"sql\",\"db_select[]\":[\"belajar_laravel\",\"phpmyadmin\",\"test\",\"xirpl5\"],\"aliases_new\":\"\",\"output_format\":\"sendit\",\"filename_template\":\"@SERVER@\",\"remember_template\":\"on\",\"charset\":\"utf-8\",\"compression\":\"none\",\"maxsize\":\"\",\"codegen_structure_or_data\":\"data\",\"codegen_format\":\"0\",\"csv_separator\":\",\",\"csv_enclosed\":\"\\\"\",\"csv_escaped\":\"\\\"\",\"csv_terminated\":\"AUTO\",\"csv_null\":\"NULL\",\"csv_structure_or_data\":\"data\",\"excel_null\":\"NULL\",\"excel_columns\":\"something\",\"excel_edition\":\"win\",\"excel_structure_or_data\":\"data\",\"json_structure_or_data\":\"data\",\"json_unicode\":\"something\",\"latex_caption\":\"something\",\"latex_structure_or_data\":\"structure_and_data\",\"latex_structure_caption\":\"Structure of table @TABLE@\",\"latex_structure_continued_caption\":\"Structure of table @TABLE@ (continued)\",\"latex_structure_label\":\"tab:@TABLE@-structure\",\"latex_relation\":\"something\",\"latex_comments\":\"something\",\"latex_mime\":\"something\",\"latex_columns\":\"something\",\"latex_data_caption\":\"Content of table @TABLE@\",\"latex_data_continued_caption\":\"Content of table @TABLE@ (continued)\",\"latex_data_label\":\"tab:@TABLE@-data\",\"latex_null\":\"\\\\textit{NULL}\",\"mediawiki_structure_or_data\":\"data\",\"mediawiki_caption\":\"something\",\"mediawiki_headers\":\"something\",\"htmlword_structure_or_data\":\"structure_and_data\",\"htmlword_null\":\"NULL\",\"ods_null\":\"NULL\",\"ods_structure_or_data\":\"data\",\"odt_structure_or_data\":\"structure_and_data\",\"odt_relation\":\"something\",\"odt_comments\":\"something\",\"odt_mime\":\"something\",\"odt_columns\":\"something\",\"odt_null\":\"NULL\",\"pdf_report_title\":\"\",\"pdf_structure_or_data\":\"data\",\"phparray_structure_or_data\":\"data\",\"sql_include_comments\":\"something\",\"sql_header_comment\":\"\",\"sql_use_transaction\":\"something\",\"sql_compatibility\":\"NONE\",\"sql_structure_or_data\":\"structure_and_data\",\"sql_create_table\":\"something\",\"sql_auto_increment\":\"something\",\"sql_create_view\":\"something\",\"sql_create_trigger\":\"something\",\"sql_backquotes\":\"something\",\"sql_type\":\"INSERT\",\"sql_insert_syntax\":\"both\",\"sql_max_query_size\":\"50000\",\"sql_hex_for_binary\":\"something\",\"sql_utc_time\":\"something\",\"texytext_structure_or_data\":\"structure_and_data\",\"texytext_null\":\"NULL\",\"yaml_structure_or_data\":\"data\",\"\":null,\"as_separate_files\":null,\"csv_removeCRLF\":null,\"csv_columns\":null,\"excel_removeCRLF\":null,\"json_pretty_print\":null,\"htmlword_columns\":null,\"ods_columns\":null,\"sql_dates\":null,\"sql_relation\":null,\"sql_mime\":null,\"sql_disable_fk\":null,\"sql_views_as_tables\":null,\"sql_metadata\":null,\"sql_drop_database\":null,\"sql_drop_table\":null,\"sql_if_not_exists\":null,\"sql_simple_view_export\":null,\"sql_view_current_user\":null,\"sql_or_replace_view\":null,\"sql_procedure_function\":null,\"sql_truncate\":null,\"sql_delayed\":null,\"sql_ignore\":null,\"texytext_columns\":null}');
...
('root', '[{\"db\":\"belajar_laravel\",\"table\":\"buku\"},{\"db\":\"belajar_laravel\",\"table\":\"kelas\"},{\"db\":\"belajar_laravel\",\"table\":\"siswa\"},{\"db\":\"belajar_laravel\",\"table\":\"pengembalian_buku\"},{\"db\":\"belajar_laravel\",\"table\":\"peminjaman_buku\"},{\"db\":\"belajar_laravel\",\"table\":\"detail_peminjaman_buku\"},{\"db\":\"belajar_laravel\",\"table\":\"jurusan\"},{\"db\":\"xirpl5\",\"table\":\"mapel\"},{\"db\":\"xirpl5\",\"table\":\"siswa\"}]');
...
('root', 'xirpl5', 'mapel', '{\"CREATE_TIME\":\"2021-08-24 08:38:41\",\"col_order\":[0,1],\"col_visib\":[1,1]}', '2021-08-24 02:20:38');
...
('root', '2021-09-24 02:01:07', '{\"Console\\/Mode\":\"collapse\",\"NavigationWidth\":242}');
...
-- Database: `xirpl5`
--
CREATE DATABASE IF NOT EXISTS `xirpl5` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `xirpl5`;
...
CREATE TABLE `mapel` (
  `id-mapel` int(3) NOT NULL,
  `nama-mapel` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, 12345, 'Artadina Septiani', 'Jl Raya Kromengan Kromengan Malang Jawa Timur');
...
--
ALTER TABLE `mapel`
  MODIFY `id-mapel` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
